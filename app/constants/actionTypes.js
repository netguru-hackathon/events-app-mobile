...
export const EVENT_PARTICIPANTS_FETCH_REQUEST = 'EVENTS_FETCH_REQUEST';
export const EVENT_PARTICIPANTS_FETCH_SUCCESS = 'EVENTS_FETCH_SUCCESS';
export const EVENT_PARTICIPANTS_FETCH_FAILURE = 'EVENTS_FETCH_FAILURE';
